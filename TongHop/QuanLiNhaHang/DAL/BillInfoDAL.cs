...
namespace QuanLiNhaHang.DAL
{
    class BillInfoDAL
    {
        ...
        {
            string query = String.Format("select m.Id , m.Name , b.Count , m.Price, (m.Price *b.Count ) as N'Thanh Tien'   from BillInfo b,Menu m where IdMenu = m.Id   and IdBill={0}", id);
